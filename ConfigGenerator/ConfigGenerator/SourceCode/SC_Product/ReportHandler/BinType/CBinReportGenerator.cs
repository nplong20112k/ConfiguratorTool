...
{
    public class Event_BinReportGenerator
    {
    ...
    class CBinReportGenerator : AReportGenerator
    {
        ...
        public CBinReportGenerator()
            : base(new Event_BinReportGenerator().m_MyEvent)
        {
            m_SubHandlerList = CFactoryBinSubHandler.GetInstance().GetSubHandlerList();
        }
                ...
                case EVENT_TYPE.EVENT_REQUEST_UPDATE_CONFIG_INFO:
                    {
                        ...
                        {
                            string sReleaseVersion = (oData as CXmlConfigInfoObject).GetReleaseVersion();
                            CBinGeneralData.setRevisonNumber(sReleaseVersion);
                            m_ShareObjectList.Add(oData);
                        }
